...
Revision ID: f55babe23b21
Revises: 
Create Date: 2025-09-16 15:31:53.645005
...
def upgrade():
    ...
    op.create_table('official_mock_exam',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('provider', sa.String(length=50), nullable=False),
    sa.Column('name', sa.String(length=150), nullable=False),
    sa.Column('exam_date', sa.Date(), nullable=False),
    sa.Column('app_start_date', sa.Date(), nullable=False),
    sa.Column('app_end_date', sa.Date(), nullable=False),
...
def downgrade():
    ...
    op.drop_table('official_mock_exam')
    op.drop_table('books')
    # ### end Alembic commands ###
